...
export type TmdbMovieDetailsAppendMap = {
  alternative_titles: { alternative_titles: TmdbMovieAlternativeTitles };
  credits: { credits: TmdbMovieCredits };
  images: {
    images: TmdbMovieImages;
  };
  recommendations: { recommendations: TmdbMovieSearch };
  similar: { similar: TmdbMovieSearch };
  translations: { translations: TmdbMovieTranslations };
};

export type AppendToTmdbMovieDetails<
  MovieDetails,
  Keys extends readonly (keyof TmdbMovieDetailsAppendMap)[],
> = MovieDetails & UnionToIntersection<TmdbMovieDetailsAppendMap[Keys[number]]>;
